    ...
    return (
        <>
            ...
            <div className='cont-real'>
                <div className="video cont-video"> <video src='con-video.mp4' autoPlay muted playsInline loop>
                    Unable to Play video</video>
                    <div className="sc-hero">
                        <h1 className='video-h'>Constellations</h1>
                        <p>"The celestial patterns that captivate our imaginations and connect
                            us to the cosmos, unrivaled in their ability to inspire wonder and curiosity."</p>
                    </div>
                </div>
                <main>
