            ...
            <div className='cont-real'>
                ...
                <main>
                    <section className="cont-hero" style={{ height: '100vh' }}>
                        ...
                        <p><b>Overview:</b>
                        <b>Orion is one of the most recognizable constellations in the night sky, often referred to as "The Hunter." It is located on the celestial equator and is visible throughout the world. Orion is named after a hunter in Greek mythology..</b></p>
                        <h3>Notable Features:</h3>
                        <ul><b>
                            <li><b>Orion Nebula (M42):</b> Located below Orion's Belt, it is one of the brightest nebulae in the sky and is visible to the naked eye. It is a region of active star formation.
                           </li>
                ...
                <div className="cont-know">
                    ...
                    <p><ul>
                        ...
                        <li><b>Bellatrix: </b>Another bright star that forms Orion's left shoulder.
</li>
