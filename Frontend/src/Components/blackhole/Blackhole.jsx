...
const Black = () => {
    const [currentPhase, setCurrentPhase] = useState(holePhases[0]);
    ...
    useEffect(() => {
        ...
        const handleClick = (event) => {
            ...
            const selectedPhase = holePhases.find(phase => phase.id === id);
    ...
    const nextStar = () => {
        setCurrentStarIndex((prevIndex) => (prevIndex + 1) % biggestholes.length);
    };

    const prevStar = () => {
        setCurrentStarIndex((prevIndex) =>
            (prevIndex - 1 + biggestholes.length) % biggestholes.length
        );
    };
        ...
        <>
            ...
            <div className="star-real">
                ...
                <div
                    ...
                    style={{
                        background: holeBackgrounds[biggestholes[currentStarIndex].id]
                    }}
                >
                    <div className='out'>
                    ...
                    <div className='container3-child'>
                        <div className='star-topic'>
                            <h2>{biggestholes[currentStarIndex].name}</h2>
                            <div className="star">
                                <div className='star-img'>
                                    ...
                                    <div className='present'>
                                        <img src={biggestholes[currentStarIndex].starImage} alt={biggestholes[currentStarIndex].name} />
                                    </div>
                                </div>
                                <div className='star-data'>
                                    <p>{biggestholes[currentStarIndex].description}</p>
                                    <div className="data-s"><a href={biggestholes[currentStarIndex].link} target="_blank" rel="noopener noreferrer">Learn more about {biggestholes[currentStarIndex].name}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
